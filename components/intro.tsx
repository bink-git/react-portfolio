...
const Intro = () => {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="mb-14 max-w-[60rem] scroll-mt-[50rem] rounded-2xl border border-black/10 bg-slate-50 p-10 text-center shadow-2xl dark:bg-slate-800 sm:mb-28 md:p-14"
    >
